      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            {item.routingEnabled && <Badge variant="outline">التوجيه</Badge>}
            {item.sendingEnabled && <Badge variant="outline">الإرسال</Badge>}
          </div>
        </div>
        <div className="flex gap-2">
          ...
          <Button
            ...
            aria-label={`إزالة ${item.hostname}`}
          >
