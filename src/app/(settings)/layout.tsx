  ...
  return (
    <AuthGuard>
      ...
      <MailboxProvider>
        <ComposeProvider>
          <MailSearchProvider>
            <div className="grid h-[100dvh] grid-cols-1 overflow-hidden bg-[#f6f8fc] transition-[grid-template-columns] duration-200 lg:grid-cols-[var(--sidebar-width)_minmax(0,1fr)]">
