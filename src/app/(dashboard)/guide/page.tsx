			...
			<div className="flex flex-col gap-8 lg:flex-row">
				...
				<div className="min-w-0 flex-1 space-y-6">
					...
					<section id="contacts" className="scroll-mt-6 rounded-3xl bg-white p-6">
						...
						<p className="text-sm leading-7 text-neutral-600">
							كل شخص تراسله يتحفظ تلقائيًا بجهات الاتصال. تلقاهم كلهم في صفحة
							«جهات الاتصال» من قائمة حسابك، أو تضغط على اسم أي شخص داخل رسالة
							مفتوحة عشان تفتح ملفه مباشرة — تقدر تشوف آخر مراسلة معه، تغيّر اسمه،
							أو تحظره لو ما تبي تستقبل منه رسايل بعد كذا.
						</p>
					</section>
					...
					<section id="calendar" className="scroll-mt-6 rounded-3xl bg-white p-6">
						...
						<p className="text-sm leading-7 text-neutral-600">
							تقدر تسوي مواعيد وتدعو لها زملاءك من صفحة التقويم — بدون ما ترسل أي
							رسالة. اختر زملاءك من القائمة والحدث يظهر عندهم في تقويمهم على طول،
							وهم يقدرون يقبلون الدعوة أو يعتذرون منها بضغطة زر.
						</p>
					</section>
